...
#define PERM_ARR    151,160,137, 91, 90, 15,131, 13,201, 95, 96, 53,194,233,\
...
//Implemented according to Ken Perlins Improved Noise
...
public:
    ...
    inline double noise_at(const double x, const double y) const
...
private:
    ...
    double noise_no_stretch(const double x, const double y) const;
